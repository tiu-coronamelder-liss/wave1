...
Aan dit onderzoek hebben `r nrow(data)` (gemiddelde leeftijd in jaren: `r round(mean(data$leeftijd), digits = 1)`, standaarddeviatie: `r round(sd(data$leeftijd), digits = 1)`, range: `r min(data$leeftijd)`-`r max(data$leeftijd)`); `r round((nrow(filter(data, geslacht == 'Vrouw'))/nrow(data))*100, digits = 2)`% vrouw) respondenten deelgenomen. De demografische statistieken zijn te vinden in de onderstaande tabel. 
...
p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`)
...
[NOTE: HOREN DEZE TABELLEN HIER TE STAAN?]
...
#### Verwachte gebruiksvriendelijkheid en zelfeffectiviteit naar gebruikersstatus

```{r chiEE1butautusernonuser, echo=FALSE}
# First calculate a proportion for the variable. 
data$EE1b_UTAUT_agree[(data$EE1b_UTAUT == 'Helemaal mee eens'| data$EE1b_UTAUT == 'Mee eens'| data$EE1b_UTAUT == 'Een beetje mee eens')] <- "Totaal eens"
data$EE1b_UTAUT_agree[(data$EE1b_UTAUT == 'Neutraal'| data$EE1b_UTAUT == 'Een beetje oneens'| data$EE1b_UTAUT == 'Oneens'| data$EE1b_UTAUT == 'Helemaal mee oneens')] <- "Neutraal, niet mee eens" 
# Select the data: Only compare the current users and never users
data_selected = data[data$nomem_encr %in% data_currentvsneveruser$nomem_encr, ]
data_selected$user_status = droplevels(data_selected$user_status)

# Convert into a table that can be used for the chi square test
chisq.table = table(data_selected$EE1b_UTAUT_agree, data_selected$user_status)
chisqtest = chisq.test(chisq.table) 
```
De chi kwadraat toets (X²(`r chisqtest$parameter`) = `r round(chisqtest$statistic, digits = 2)`, p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`) liet zien dat er `r if(chisqtest$p.value > 0.05){"g"}`een significant verschil was in het percentage gebruikers (`r round((nrow(filter(data_selected, (user_status == 'Gebruiker'& EE1b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status == 'Gebruiker'))))*100, digits = 1)`%) dat aangaf het eens te zijn met de stelling dat het gebruik van de CoronaMelder veel tijd en energie kost, vergeleken met degenen die de app nooit hebben gebruikt (`r round((nrow(filter(data_selected, (user_status == 'Niet gebruiker' & EE1b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status == 'Niet gebruiker'))))*100, digits = 1)`%).  

```{r chiEE1butautusernonuserneutral, echo=FALSE}
# First calculate a proportion for the variable. 
data$EE1b_UTAUT_agree[(data$EE1b_UTAUT == 'Helemaal mee eens'| data$EE1b_UTAUT == 'Mee eens'| data$EE1b_UTAUT == 'Een beetje mee eens')] <- "Totaal eens"
data$EE1b_UTAUT_agree[(data$EE1b_UTAUT == 'Neutraal'| data$EE1b_UTAUT == 'Een beetje oneens'| data$EE1b_UTAUT == 'Oneens'| data$EE1b_UTAUT == 'Helemaal mee oneens')] <- "Neutraal, niet mee eens" 
# Select the data: Only compare the current users and never users
...
# Convert into a table that can be used for the chi square test
chisq.table = table(data_selected$EE1b_UTAUT_agree, data_selected$user_status_intention)
chisqtest = chisq.test(chisq.table) 
```
De chi kwadraat toets (X²(`r chisqtest$parameter`) = `r round(chisqtest$statistic, digits = 2)`, p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`) liet zien dat er `r if(chisqtest$p.value > 0.05){"g"}`een significant verschil was in het percentage gebruikers (`r round((nrow(filter(data_selected, (user_status_intention == 'Gebruiker'& EE1b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status_intention == 'Gebruiker'))))*100, digits = 1)`%) dat aangaf het eens te zijn met de stelling dat het gebruik van de CoronaMelder veel tijd en energie kost, vergeleken met degenen die de app nooit hebben gebruikt en daarnaast aangaven neutraal te zijn in hun intentie om de CoronaMelder te gaan gebruiken (`r round((nrow(filter(data_selected, (user_status_intention == 'Nooit gebruikt en neutraal' & EE1b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status_intention == 'Nooit gebruikt en neutraal'))))*100, digits = 1)`%).

```{r chiEE2butautusernonuser, echo=FALSE}
# First calculate a proportion for the variable. 
data$EE2b_UTAUT_agree[(data$EE2b_UTAUT == 'Helemaal mee eens'| data$EE2b_UTAUT == 'Mee eens'| data$EE2b_UTAUT == 'Een beetje mee eens')] <- "Totaal eens"
data$EE2b_UTAUT_agree[(data$EE2b_UTAUT == 'Neutraal'| data$EE2b_UTAUT == 'Een beetje oneens'| data$EE2b_UTAUT == 'Oneens'| data$EE2b_UTAUT == 'Helemaal mee oneens')] <- "Neutraal, niet mee eens" 
# Select the data: Only compare the current users and never users
data_selected = data[data$nomem_encr %in% data_currentvsneveruser$nomem_encr, ]
data_selected$user_status = droplevels(data_selected$user_status)

# Convert into a table that can be used for the chi square test
chisq.table = table(data_selected$EE2b_UTAUT_agree, data_selected$user_status)
chisqtest = chisq.test(chisq.table) 
```
De chi kwadraat toets (X²(`r chisqtest$parameter`) = `r round(chisqtest$statistic, digits = 2)`, p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`) liet zien dat er `r if(chisqtest$p.value > 0.05){"g"}`een significant verschil was in het percentage gebruikers (`r round((nrow(filter(data_selected, (user_status == 'Gebruiker'& EE2b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status == 'Gebruiker'))))*100, digits = 1)`%) dat aangaf het eens te zijn met de stelling dat de CoronaMelder makkelijk te gebruiken is, vergeleken met degenen die de app nooit hebben gebruikt (`r round((nrow(filter(data_selected, (user_status == 'Niet gebruiker' & EE2b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status == 'Niet gebruiker'))))*100, digits = 1)`%).  

```{r chiEE2butautusernonuserneutral, echo=FALSE}
# First calculate a proportion for the variable. 
data$EE2b_UTAUT_agree[(data$EE2b_UTAUT == 'Helemaal mee eens'| data$EE2b_UTAUT == 'Mee eens'| data$EE2b_UTAUT == 'Een beetje mee eens')] <- "Totaal eens"
data$EE2b_UTAUT_agree[(data$EE2b_UTAUT == 'Neutraal'| data$EE2b_UTAUT == 'Een beetje oneens'| data$EE2b_UTAUT == 'Oneens'| data$EE2b_UTAUT == 'Helemaal mee oneens')] <- "Neutraal, niet mee eens" 
# Select the data: Only compare the current users and never users
...
# Convert into a table that can be used for the chi square test
chisq.table = table(data_selected$EE2b_UTAUT_agree, data_selected$user_status_intention)
chisqtest = chisq.test(chisq.table) 
```

De chi kwadraat toets (X²(`r chisqtest$parameter`) = `r round(chisqtest$statistic, digits = 2)`, p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`) liet zien dat er `r if(chisqtest$p.value > 0.05){"g"}`een significant verschil was in het percentage gebruikers (`r round((nrow(filter(data_selected, (user_status_intention == 'Gebruiker'& EE2b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status_intention == 'Gebruiker'))))*100, digits = 1)`%) dat aangaf het eens te zijn met de stelling dat de CoronaMelder makkelijk te gebruiken is, vergeleken met degenen die de app nooit hebben gebruikt en daarnaast aangaven neutraal te zijn in hun intentie om de CoronaMelder te gaan gebruiken (`r round((nrow(filter(data_selected, (user_status_intention == 'Nooit gebruikt en neutraal' & EE2b_UTAUT_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status_intention == 'Nooit gebruikt en neutraal'))))*100, digits = 1)`%). 

```{r chiHBMselfefficacyCoronaMelderutautusernonuser, echo=FALSE}
# First calculate a proportion for the variable. 
data$HBM_selfefficacy_CoronaMelder_agree[(data$HBM_selfefficacy_CoronaMelder == 'Helemaal mee eens'| data$HBM_selfefficacy_CoronaMelder == 'Mee eens'| data$HBM_selfefficacy_CoronaMelder == 'Een beetje mee eens')] <- "Totaal eens"
data$HBM_selfefficacy_CoronaMelder_agree[(data$HBM_selfefficacy_CoronaMelder == 'Neutraal'| data$HBM_selfefficacy_CoronaMelder == 'Een beetje oneens'| data$HBM_selfefficacy_CoronaMelder == 'Oneens'| data$HBM_selfefficacy_CoronaMelder == 'Helemaal mee oneens')] <- "Neutraal, niet mee eens" 
# Select the data: Only compare the current users and never users
data_selected = data[data$nomem_encr %in% data_currentvsneveruser$nomem_encr, ]
data_selected$user_status = droplevels(data_selected$user_status)

# Convert into a table that can be used for the chi square test
chisq.table = table(data_selected$HBM_selfefficacy_CoronaMelder_agree, data_selected$user_status)
chisqtest = chisq.test(chisq.table) 
```
De chi kwadraat toets (X²(`r chisqtest$parameter`) = `r round(chisqtest$statistic, digits = 2)`, p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`) liet zien dat er `r if(chisqtest$p.value > 0.05){"g"}`een significant verschil was in het percentage gebruikers (`r round((nrow(filter(data_selected, (user_status == 'Gebruiker'& HBM_selfefficacy_CoronaMelder_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status == 'Gebruiker'))))*100, digits = 1)`%) dat aangaf het eens te zijn met de stelling in staat te zijn om de CoronaMelder te gebruiken, vergeleken met degenen die de app nooit hebben gebruikt (`r round((nrow(filter(data_selected, (user_status == 'Niet gebruiker' & HBM_selfefficacy_CoronaMelder_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status == 'Niet gebruiker'))))*100, digits = 1)`%).  


```{r chiHBMselfefficacyCoronaMelderutautusernonuserneutral, echo=FALSE}
# First calculate a proportion for the variable. 
data$HBM_selfefficacy_CoronaMelder_agree[(data$HBM_selfefficacy_CoronaMelder == 'Helemaal mee eens'| data$HBM_selfefficacy_CoronaMelder == 'Mee eens'| data$HBM_selfefficacy_CoronaMelder == 'Een beetje mee eens')] <- "Totaal eens"
data$HBM_selfefficacy_CoronaMelder_agree[(data$HBM_selfefficacy_CoronaMelder == 'Neutraal'| data$HBM_selfefficacy_CoronaMelder == 'Een beetje oneens'| data$HBM_selfefficacy_CoronaMelder == 'Oneens'| data$HBM_selfefficacy_CoronaMelder == 'Helemaal mee oneens')] <- "Neutraal, niet mee eens" 
# Select the data: Only compare the current users and never users
...
# Convert into a table that can be used for the chi square test
chisq.table = table(data_selected$HBM_selfefficacy_CoronaMelder_agree, data_selected$user_status_intention)
chisqtest = chisq.test(chisq.table) 
```

De chi kwadraat toets (X²(`r chisqtest$parameter`) = `r round(chisqtest$statistic, digits = 2)`, p `r ifelse(chisqtest$p.value < 0.001, "<0.001", paste("=", round(chisqtest$p.value, digits = 3)))`) liet zien dat er `r if(chisqtest$p.value > 0.05){"g"}`een significant verschil was in het percentage gebruikers (`r round((nrow(filter(data_selected, (user_status_intention == 'Gebruiker'& HBM_selfefficacy_CoronaMelder_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status_intention == 'Gebruiker'))))*100, digits = 1)`%) dat aangaf het eens te zijn met de stelling in staat te zijn om de CoronaMelder te gebruiken, vergeleken met degenen die de app nooit hebben gebruikt en daarnaast aangaven neutraal te zijn in hun intentie om de CoronaMelder te gaan gebruiken (`r round((nrow(filter(data_selected, (user_status_intention == 'Nooit gebruikt en neutraal' & HBM_selfefficacy_CoronaMelder_agree == 'Totaal eens'))) /nrow(filter(data_selected, (user_status_intention == 'Nooit gebruikt en neutraal'))))*100, digits = 1)`%). 


```{r, echo=FALSE, tab.cap ="Verwachte gebruiksvriendelijkeheid en eigen effectiviteit naar gebruikersstatus. Aantal en totaal percentage eens (beetje mee eens, eens, helemaal mee eens)."}
...
## Demografie
Opvallend is dat hoger opgeleiden vaker de CoronaMelder gebruiken dan lager opgeleiden. Hiermee in lijn is de bevinding dat het percentage gebruikers het hoogst was bij de mensen met hogere inkomens (boven 3501 euro).  
Daarnaast is het gebruik van de CoronaMelder het laagst in de jongste leeftijdscategorie (tot 24 jaar).   
...
Daarnaast was het zo dat de verwachte effectiviteit veel hoger was bij de gebruikers vergeleken met degenen die de de CoronaMelder (nog) niet gebruiken. --> FActor om op in te spelen. 

## Vertrouwen in de techniek
Een overgroot deel gelooft dat de techniek (bluetooth) die gebruikt wordt in de CoronaMelder inderdaad kan aangeven wie er in de buurt is geweest van een persoon die besmet is. 

## Gebruiksvriendelijkheid 
Opvallend is dat 1 op de 5 mensen die de CoronaMelder nog niet gebruikt, denkt dat het veel tijd en energie kost om deze te gaan gebruiken en een groot deel hier neutraal in staat. Daat staat tegenover dat van de mensen die de CoronaMelder al gebruiken, slechts 3.5% aangaf dat dit inderdaad het geval was. Bijna 9 op de 10 gaf aan het niet eens te zijn met deze stelling. 

## Sociale invloeden
Zeer lage descriptieve en injunctieve normen mbt. mensen in hun directe omgeving. Redelijk goede inschatting van adoptie in de hele populatie. Mensen denken zich te bevinden in een groep waarin niet veel anderen de CoronaMelder gebruiken. 
Onzichtbaarheid van gebruik (itt tot mondkapjes). 
