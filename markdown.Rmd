...
--> To do: nog uitwerken Corona_complaints + Behavior_AdherenceGeneralMeasures_quarantaine
...
```{r coronacomplaintsquarantaine, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Naleving algemene gedragsregels"}
...
--> To do: not uitwerken Beliefs_TrustGovernment.
...
#### Per (potentiële) gebruikersgroep
```{r, echo=FALSE}
...
--> To do: uitwerken Beliefs_datasafety
...
# Order in which you would like to have the items appear (first = top, last = bottom) in the horizontal bar chart
graph_variablenames = c("Beliefs_locationmonitoring", 
                        "Beliefs_identitymonitoring")
graph_questionlabels = c("De CoronaMelder houdt\n mijn locatie bij", 
...
--> To do: uitwerken: Beliefs_falsesecurity1
