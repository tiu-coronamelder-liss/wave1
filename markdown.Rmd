...
#reversecode_scheme_7point = "1=7; 2=6; 3=5; 4=4; 5=3; 6=2; 7=1; NA=NA"
#data$HealthLiteracy1rec <- recode(data$HealthLiteracy1,reversecode_scheme_7point)
View(data)

#data$HealthLiteracy1r <- recode(data$HealthLiteracy1, "'Nooit'='Altijd'; 'Af en toe'='Vaak'; 'Vaak'='Af en toe'; 'Altijd'='Nooit'")
...
#data$CatHL <- cut(hl_scale, breaks = c(0,1.333333,3.66666,5), labels = c("Laag", "Midden", "Hoog"))
...
#### 3.2.2.2 Corona risicoperceptie en ernst
```{r PSus, echo=FALSE}
...
#### 3.4.1.1 Ontvangen meldingen en opvolging van de adviezen
#### 3.4.1.2 Intentie tot opvolgen adviezen gegeven in de melding
##### 3.4.1.2.1 Bij aanwezigheid symptomen die passen bij een besmetting met het coronavirus
##### 3.4.1.2.2 Bij afwezigheid symptomen die passen bij een besmetting met het coronavirus
#### 3.4.1.3 Verklarende factoren opvolging adviezen gegeven in melding
##### 3.4.1.3.1 Eigen effectiviteit opvolging adviezen
##### 3.4.1.3.2 Gepercipieerde persoonlijke voor- en nadelen van opvolgen adviezen
