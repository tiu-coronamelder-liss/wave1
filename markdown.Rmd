...
```{r, echo=FALSE, tab.cap ="Verwachte gebruiksvriendelijkeheid en zelfeffectiviteit naar gebruikersstatus. Aantal en totaal percentage eens (beetje mee eens, eens, helemaal mee eens)."}
