...
```{r behavior adherence general measures, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Naleving algemene gedragsregels"}
...
```{r intention adherence general measures, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Naleving algemene gedragsregels"}
...
graph_questionlabels = c("... mijn handen regelmatig te wassen", 
                         ...
                         "... thuis te blijven als ik last heb\n van klachten die passen bij het coronavirus"); 
...
```{r perceived susceptibility and severity, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Waargenomen ernst en vatbaarheid - Niet gebruikers"}
...
```{r adherence to notifications in the app, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Thuisblijven na melding"}
...
``` {r adherence to notifications no symptoms, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Intentie tot opvolgen adviezen zonder symptomen"}
# Order in which you would like to have the items appear (first = top, last = bottom) in the horizontal bar chart
...
```{r adherence to notifications symptoms, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Intentie tot opvolgen adviezen zonder symptomen"}
# Order in which you would like to have the items appear (first = top, last = bottom) in the horizontal bar chart
...
```{r adherence notifications self efficacy, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Eigen effectiviteit om adviezen op te volgen"}
...
```{r HBM benefits, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Persoonlijke voordelen om adviezen op te volgen"}
...
```{r HBM barriers, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Persoonlijke nadelen om adviezen op te volgen"}
