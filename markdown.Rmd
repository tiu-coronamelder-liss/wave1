...
---
```{r uvtlogo, echo=FALSE, fig.cap="my caption", out.width = '90%'}
knitr::include_graphics("images/uvtlogo.jpg")
```
...
### Full page breaks are added with ###### Page break (as described in: https://datascienceplus.com/r-markdown-how-to-insert-page-breaks-in-a-ms-word-document/) 
