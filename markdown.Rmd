...
```{r Beliefsappadoption, echo=FALSE, fig.width=5.5, fig.height=3, fig.cap="Percentage Nederlandse bevolking dat volgens de respondent de CoronaMelder gebruikt"}
