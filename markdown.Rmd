...
```{r intentiontousecurrentusers, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Intentie tot gebruik bij respondenten die de CoronaMelder op dit moment al gebruiken", tab.cap="Intentie tot gebruik bij respondenten die de CoronaMelder op dit moment al gebruiken"}
...
```{r technology, echo=FALSE, fig.width=7, fig.height=2, fig.cap="Geloof in techniek", tab.cap="Geloof in techniek"}
# Order in which you would like to have the items appear (first = top, last = bottom) in the horizontal bar chart
...
```{r , echo=FALSE, fig.width=7, fig.height=2, fig.cap="", tab.cap=""}
